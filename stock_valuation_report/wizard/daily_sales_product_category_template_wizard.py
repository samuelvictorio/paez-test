...
class DailySalesReportWizard(models.TransientModel):
    ...
    def print_report(self):
        ...
        return self.env.ref('ob_stock_valuation_report.inventory_product_category_template_pdf').report_action(self)
    ...
    def print_exl_report(self):
        if xlwt:
            ...
            if self.display_sum:
                ...
                worksheet.write_merge(0, 1, 2, 9, "Inventory Valuation Report Summary", style=style_title)
